...
*/
function clearAll() {
const clearJoke = document.querySelector('.joke-container').innerHTML = '';
const clearMeme = document.querySelector('.meme-container').innerHTML = '';
const clearQuote = document.querySelector('.quote-container').innerHTML = '';
const clearRiddle = document.querySelector('.riddle-container').innerHTML = '';
}
...
function showRiddle() {
  ...
  //const {question, answer} = randomRiddle; this is a simplified way to get the data from the object
  ...
  newRiddle.setAttribute('id', 'riddle-question')
...
const riddles = [
  ...
  { question: 'What word in the English language does the following: the first two letters signify a male, the first three letters signify a female, the first four letters signify a great man, while the entire word signifies a great woman. What is the word?', answer: 'Heroine' }
];
